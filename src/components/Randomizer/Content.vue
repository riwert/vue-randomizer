        ...
        <v-col class="text-center">
          ...
          <div class="my-4">
            ...
            >
              <template v-slot:activator="{ on }">
                <v-btn color="success" class="ma-2" v-on="on">
                  Load example
                </v-btn>
              </template>
              <v-list>
            ...
            <v-btn color="error" class="ma-2" @click="clearInput">Clear input</v-btn>
          </div>
          ...
          <v-row align="center" class="mb-4">
            ...
            <v-col class="text-left" cols="6">
              <v-btn color="primary" @click="onSubmit">Randomize</v-btn>
            </v-col>
          </v-row>
          ...
          <div class="my-0">
            <v-btn color="warning" class="ma-2" @click="saveOutput">Save result</v-btn>
            <v-btn color="error" class="ma-2" @click="clearOutput">Clear result</v-btn>
          </div>
